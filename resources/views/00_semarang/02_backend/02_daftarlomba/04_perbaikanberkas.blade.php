...
<div class="content-form-wrapper" style="background: white; padding: 20px; border-radius: 8px;">
    <form action="{{ route('daftarlombatimperbaikan', $data->id) }}" method="POST" enctype="multipart/form-data" class="full-width-form" style="background: white;">
    @csrf
    <!-- begin::Body -->
  <div style="display: flex; justify-content: center; align-items: center; width: 100%;">
    <button class="button-maroon" style="margin-bottom:10px;">
        <span>Halaman Perbaikan Berkas Saudara !</span>
    </button>
</div>
    ...
    >
        ...
        @foreach($provinsiList as $provinsi)
            <option value="{{ $provinsi->id }}"
                {{ old('provinsi_id', $data->provinsi_id ?? '') == $provinsi->id ? 'selected' : '' }}>
                {{ $provinsi->provinsi }}
            </option>
        @endforeach
    </select>
...
<div class="form-group" style="margin-top: 15px;">
    ...
    <textarea
        ...
        rows="4"
    >{{ old('alamat_organisasi', $data->alamat_organisasi ?? '') }}</textarea>
...
<div class="form-row" style="display: flex; gap: 20px; flex-wrap: wrap; background: white; padding: 15px; border-radius: 8px;">
  <!-- Foto -->
{{-- Tampilkan data sebelumnya kalau ada --}}
@if(isset($data->kategoriperlombaan_id))
    <div class="mb-2" style="font-size: 14px; color: #555;">
        <strong>Kategori sebelumnya:</strong>
        {{ $data->kategoriperlombaan->kategoriperlombaan ?? '-' }}
    </div>
@endif
        ...
        >
            ...
            @foreach($kategoriperlombaan as $kategori)
                <option value="{{ $kategori->id }}"
                    {{ old('kategoriperlombaan_id', $data->kategoriperlombaan_id ?? '') == $kategori->id ? 'selected' : '' }}>
...
<div class="form-column" style="flex: 0 0 48%; min-width: 280px;">
    <div class="form-group">
        ...
        @if(!empty($data->surat_tugas_organisasi))
            <div class="mb-2" style="font-size: 14px; color: #555;">
                <strong>File sebelumnya:</strong>
                <a href="{{ asset($data->surat_tugas_organisasi) }}" target="_blank" style="text-decoration: underline; color: #007bff;">
                    Lihat / Download
                </a>
            </div>
            <embed src="{{ asset($data->surat_tugas_organisasi) }}"
...
<div class="form-column" style="flex: 0 0 48%; min-width: 280px;">
    <div class="form-group">
        ...
        @if(!empty($data->surat_keterangan_sehat))
            <div class="mb-2" style="font-size: 14px; color: #555;">
                <strong>File sebelumnya:</strong>
                <a href="{{ asset($data->surat_keterangan_sehat) }}" target="_blank" style="text-decoration: underline; color: #007bff;">
                    Lihat / Download
                </a>
            </div>
            <embed src="{{ asset($data->surat_keterangan_sehat) }}" style="margin-top:5px; width:100%; height:300px;" type="application/pdf" />
        @else
            <div class="mb-2" style="font-size: 14px; color: red;">
                Data belum diupload
            </div>
...
<div class="form-column" style="flex: 0 0 48%; min-width: 280px;">
    <div class="form-group">
        ...
        @if(!empty($data->bukti_pembayaran))
            <div class="mb-2" style="font-size: 14px; color: #555;">
                <strong>File sebelumnya:</strong>
                <a href="{{ asset($data->bukti_pembayaran) }}" target="_blank" style="text-decoration: underline; color: #007bff;">
                    Lihat / Download
                </a>
            </div>
            <embed src="{{ asset($data->bukti_pembayaran) }}" style="margin-top:5px; width:100%; height:300px;" type="application/pdf" />
        @else
            <div class="mb-2" style="font-size: 14px; color: red;">
                Data belum diupload
            </div>
...
<div class="form-column" style="flex: 0 0 48%; min-width: 280px;">
    <div class="form-group">
        ...
        @if(!empty($data->surat_pernyataan))
            <div class="mb-2" style="font-size: 14px; color: #555;">
                <strong>File sebelumnya:</strong>
                <a href="{{ asset($data->surat_pernyataan) }}" target="_blank" style="text-decoration: underline; color: #007bff;">
                    Lihat / Download
                </a>
            </div>
            <embed src="{{ asset($data->surat_pernyataan) }}" style="margin-top:5px; width:100%; height:300px;" type="application/pdf" />
        @else
            <div class="mb-2" style="font-size: 14px; color: red;">
                Data belum diupload
            </div>
