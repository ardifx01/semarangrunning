...
<body>
  ...
  <thead>
    <tr>
      ...
      <th><i class="bi bi-geo-alt-fill text-success me-1"></i> Tempat</th>
      <th><i class="bi bi-compass-fill text-info me-1"></i> Koordinat</th>
  ...
  <tbody>
    @foreach ($data as $item)
      <tr>
        ...
        <td><i class="bi bi-flag-fill text-primary me-1"></i> {{ $item->kegiatan }}</td>
        <td><i class="bi bi-geo-alt-fill text-success me-1"></i> {{ $item->tempat }}</td>
        <td><i class="bi bi-compass-fill text-info me-1"></i> {{ $item->koordinat }}</td>
        <td><i class="bi bi-pin-map-fill text-warning me-1"></i> {{ $item->lokasi }}</td>
      </tr>
    @endforeach
  </tbody>
</table>
