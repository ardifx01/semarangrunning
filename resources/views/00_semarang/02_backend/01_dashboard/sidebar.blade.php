<div class="sidebar" id="sidebar" style="background-color: #1a1a1a; padding: 16px;">
  ...
  <div class="sidebar-menu" style="margin-top: 20px;">
    <a href="/dashboard" class="menu-item active" style="color: white; text-decoration: none; display: flex; align-items: center; gap: 8px; margin-bottom: 12px;">
      <i class="bi bi-speedometer2" style="color: white;"></i><span>Dashboard</span>
    </a>
    <a href="/beperlombaan" class="menu-item" style="color: white; text-decoration: none; display: flex; align-items: center; gap: 8px; margin-bottom: 12px;">
      <i class="bi bi-people-fill" style="color: white;"></i><span>Perlombaan</span>
    </a>
    <a href="/bepeserta" class="menu-item" style="color: white; text-decoration: none; display: flex; align-items: center; gap: 8px; margin-bottom: 12px;">
      <i class="bi bi-bar-chart-fill" style="color: white;"></i><span>Peserta</span>
    </a>

    <!-- Menu Peta (Trigger) -->
<a href="javascript:void(0);" onclick="toggleSubmenu()" class="menu-item"
   style="color: white; text-decoration: none; display: flex; align-items: center; gap: 8px; margin-bottom: 12px;">
  <i class="bi bi-geo-alt-fill" style="color: white;"></i>
  <span>Peta</span>
  <i class="bi bi-caret-down-fill ms-auto" style="color: white;"></i>
</a>

<!-- Submenu Peta (Tersembunyi awalnya) -->
...
<script>
  function toggleSubmenu() {
    ...
    <a href="/laporan" class="menu-item" style="color: white; text-decoration: none; display: flex; align-items: center; gap: 8px;">
      <i class="bi bi-file-earmark-text-fill" style="color: white;"></i><span>Laporan</span>
    </a>
  </div>
</div>
